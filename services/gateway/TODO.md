...
JWKS is fetched on startup and refreshed every 15 minutes. Startup fetch failure → degraded (`/health/ready` 503 until JWKS loads). Cold-path fetch holds the JWKS mutex across the network call.

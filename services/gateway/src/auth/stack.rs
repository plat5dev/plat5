...
use crate::auth::member_session::{MemberSessionCache, MemberSessionValidator};
...
const MEMBER_SESSION_CACHE_CAPACITY: u64 = 10_000;
...
pub struct AuthStack {
    ...
    pub member_session_validator: MemberSessionValidator,
    pub member_session_cache: MemberSessionCache,
}
...
impl AuthStack {
    pub fn from_config(cfg: &GatewayConfig, jwt_validator: JwtValidatorState) -> Self {
        ...
        let member_session_validator =
            MemberSessionValidator::new(cfg.member_session_validate_url.clone(), http);
        ...
        Self {
            ...
            member_session_validator,
            member_session_cache: MemberSessionCache::new(
                MEMBER_SESSION_CACHE_CAPACITY,
                cfg.apikey_cache_ttl_secs,
            ),
        }
    }
